    ...
    <section className="relative bg-gradient-to-b from-primary-600 to-primary-700 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 opacity-10">
        <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="locationsGrid" width="40" height="40" patternUnits="userSpaceOnUse">
              <path d="M 40 0 L 0 0 0 40" fill="none" stroke="currentColor" strokeWidth="1" />
            </pattern>
          </defs>
          <rect width="100%" height="100%" fill="url(#locationsGrid)" />
        </svg>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-16 md:py-24 relative z-10 max-w-5xl">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto">
            Redhawk Relocation connects you with moving help in 10 major cities across the United States. Find reliable
            moving professionals in your area through our platform.
          </p>
        </div>
      </div>
